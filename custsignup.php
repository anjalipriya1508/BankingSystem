...
<tr ><td style="font-size:24px;color:white;background-color:gray;"><a href="custacdetlist.php" align="center" style="font-weight:bold;text-align:center;">Back</a></td><td style="font-size:24px; background-color:green;"><input  align="center" type="submit" name="login" value="Sign Up"  style="padding-right:10px;  padding-left:10px ;font-weight:bold;background-color:green;text-align:center;"></td></tr>
<?php
if($res=="1")
